...
<details>
<summary><b>Data Entry Operator @ SLT Mobitel Pvt. Ltd</b> — May 2021 – Dec 2021</summary>
<br/>

> `Customer Service` `Data Entry` `Telecommunications`

- Handled inbound and outbound customer service calls for a leading telecommunications provider, ensuring customer satisfaction and efficient issue resolution.
- Entered and maintained large volumes of customer and business data with a focus on accuracy and efficiency.

</details>

<details>
<summary><b>Trainee Draughtsman @ Batticaloa District Secretariat</b> — Feb 2023 – Jul 2023</summary>
<br/>

> `AutoCAD` `Technical Drawing` `Site Surveys`

- Assisted in drafting technical drawings for the new Secretariat office using AutoCAD.
- Collaborated with senior draughtsmen and conducted site visits to ensure design accuracy.

</details>

<details>
<summary><b>Trainee Draughtsman @ ASDC (Pvt) Ltd</b> — Aug 2023 – Nov 2023</summary>
<br/>

> `AutoCAD` `Blueprint Reading` `Project Documentation`

- Assisted in creating detailed technical drawings and plans for construction and engineering projects.
- Collaborated with senior draftsmen and engineers to ensure accuracy and adherence to specifications.
- Developed skills in CAD software, blueprint reading, and project documentation while supporting design revisions.
...
|---|---|---|
| BSc (Hons) Data Science | Sri Lanka Technology Campus | 2023 – 2027 |
| National Certificate in Engineering (Draughtsman) | BT / Technical College, Batticaloa | 2022 – 2023 |
